...
/****** Object:  Database [FinalProjectDB]    Script Date: 08/11/2014 09:44:44 ******/
CREATE DATABASE [FinalProjectDB] ON  PRIMARY 
( NAME = N'FinalProjectDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\FinalProjectDB.mdf' , SIZE = 2048KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'FinalProjectDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10_50.SQLEXPRESS\MSSQL\DATA\FinalProjectDB_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [FinalProjectDB] SET COMPATIBILITY_LEVEL = 100
GO
